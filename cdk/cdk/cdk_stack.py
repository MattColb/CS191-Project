...
from cdk.cdk.components.email_components.notification_system import create_notification_system
...
class CdkStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        verification_queue = aws_sqs.Queue(scope, "BuzzyBeeVerificationQueue")
